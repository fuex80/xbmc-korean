...
def extract_video_from_url(main_url):
  ...
  if query:
    ptcnt = 1
    for url in query.group(1).split('|'):
...
if __name__ == "__main__":
  print extract_video_from_url("http://www.tudou.com/programs/view/ubrrVcYGweA/")
  print extract_video_from_url("http://v.youku.com/v_show/id_XNTgwMTEwNTI4")
  print extract_video_from_url("http://my.tv.sohu.com/u/vw/1882940")
