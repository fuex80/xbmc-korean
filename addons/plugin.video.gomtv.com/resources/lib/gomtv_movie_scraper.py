...
if __name__ == "__main__":
    ...
    print scraper.parseMoviePage( 'http://movie.gomtv.com/14025' )
    print scraper.parseMovieHotClipPage( 'http://movie.gomtv.com/sub/detailAjax.gom?misid=15814&dispid=14025&vodid=27354&mtype=5' )
    print scraper.parseMovieChartPage( 'http://movie.gomtv.com/list.gom?cateid=4' )
    print scraper.parsePremierPage( 'http://movie.gomtv.com/list.gom?cateid=65' )
    print scraper.parseHotClipPage( 'http://movie.gomtv.com/release/hotclip.gom' )
    print scraper.parseBoxOfficePage( 'http://movie.gomtv.com/release/boxoffice.gom' )
