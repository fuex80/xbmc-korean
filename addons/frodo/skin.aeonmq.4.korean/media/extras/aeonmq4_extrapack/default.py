...
SCRIPTID = "script.aeon.mq4.updater"
ADDONNAME = "Aeon MQ 4"
TARGETID = "skin.extrapack.aeonmq.4"

if ( __name__ == "__main__" ):
	
	xbmc.log('start aeonmq.4 updater')
		
	updater = Updater()
	
	updater.SFAddress = "http://mod-skin.googlecode.com/svn/trunk/skin.aeonmq.4.extrapack/"
	updater.SFViewVC = ""
